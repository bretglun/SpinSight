...
TISSUES = {
    'gray':       {'PD': 1.0  , 'FF': .00, 'T1': {1.5: 1100, 3.0: 1330}, 'T2': {1.5:   95, 3.0:   99}},
    'white':      {'PD': 0.9  , 'FF': .00, 'T1': {1.5:  560, 3.0:  830}, 'T2': {1.5:   72, 3.0:   69}},
    'CSF':        {'PD': 1.0  , 'FF': .00, 'T1': {1.5: 4280, 3.0: 4160}, 'T2': {1.5: 2030, 3.0: 2100}},
    'adipose':    {'PD': 1.0  , 'FF': .95, 'T1': {1.5:  290, 3.0:  370}, 'T2': {1.5:  165, 3.0:  130}},
    'bonemarrow': {'PD': 1.0  , 'FF': .50, 'T1': {1.5:  856, 3.0:  898}, 'T2': {1.5:   46, 3.0:   34}}, # relaxation times for water component
    ...
    'kidneyMed':  {'PD': 1.0  , 'FF': .00, 'T1': {1.5: 1412, 3.0: 1545}, 'T2': {1.5:   85, 3.0:   81}},
    'kidneyCor':  {'PD': 1.0  , 'FF': .00, 'T1': {1.5:  966, 3.0: 1142}, 'T2': {1.5:   87, 3.0:   76}},
    'spinalCord': {'PD': 1.0  , 'FF': .00, 'T1': {1.5:  745, 3.0:  993}, 'T2': {1.5:   74, 3.0:   78}},
    'cortical':   {'PD': 0.05 , 'FF': .00, 'T1': {1.5: 1000, 3.0: 1000}, 'T2': {1.5:    3, 3.0:    1}},
